...
import pic from "../../../../img/favicon.png"
...
import { DEFAULT_SOUND_TYPE } from "../sound/sound";
...
const TypeBox = ({
  ...
  const [play] = useSound(DEFAULT_SOUND_TYPE, { volume: 0.5 });
  ...
  return (
    <div onClick={handleInputFocus} >
      <Navbar sticky="top" >
        <Container fluid>
          <img src={pic} alt="logo" width="3%" />
          <span style={{ marginLeft: "20px", fontSize: "1.4em" }}><span style={{ color: "#3ec276" }}>Welcome,</span> <b style={{ color: "white" }}>{name}</b></span>
      ...
      <img src={Logo} alt="WPM Test !!!" style={{ width: "30%", position: "relative", left: "50%", right: "50%", top: "150%", transform: 'translate( -50%,0%)' }} />
